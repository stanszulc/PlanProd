...
export function PlanTab({ routing, zp, globalLookups, wcSchedule, subZP, fwdZP, zpStatus,
  ...
  return (
    <div className="plan-tab">
      ...
      <div className="plan-panel plan-panel--gantt">
        <div className="plan-panel__header">📊 Harmonogram (Gantt)</div>
      ...
      <div className="plan-panel plan-panel--grafik">
        <div className="plan-panel__header">📅 Grafik zasobów — dostępność vs zapotrzebowanie</div>
        <div className="plan-panel__body">
          <GrafikTab
            embedded
      ...
      {zpStatus && zpStatus.length > 0 && (
        <div className="plan-panel plan-panel--status">
          <div className="plan-panel__header">📋 Status ZP — TOC Buffer Management</div>
